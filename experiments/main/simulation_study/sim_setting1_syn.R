...
write.csv(
  raw_df,
  file = file.path(csv_dir, "syn_setting1_summary_amf.csv"),
  row.names = FALSE
)
write.csv(
  df,
  file = file.path(csv_dir, "syn_setting1_plot_summary_amf.csv"),
  row.names = FALSE
)
ggsave(
  filename = file.path(figure_dir, "syn_setting1_plot_amf.png"),
  plot = p_1,
  width = 12,
  height = 4,
  dpi = 300,
...
ggsave(
  filename = file.path(figure_dir, "syn_setting1_plot_amf.pdf"),
  plot = p_1,
  width = 12,
  height = 4,
  bg = "white"
